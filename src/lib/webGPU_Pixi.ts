...
const activeStyle: LineStyle = { color: 0x80bfd6, width: 3, alpha: 1, zIndex: 0 };
const inactiveStyle: LineStyle = { color: 0xebebeb, width: 2, alpha: 1, zIndex: 0 };
const hoverStyle: LineStyle = { color: 0xff3333, width: 4, alpha: 1, zIndex: 1 };
const selectedStyle: LineStyle = { color: 0xffff00, width: 4, alpha: 1, zIndex: 2 };
...
function drawLine(graphics: PIXI.Graphics, pts: [number, number][], style: LineStyle) {
  graphics.clear();
  if (pts.length > 0) {
